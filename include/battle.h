...
// Used to be type-based. Now is defined in a move's own data
#define IS_MOVE_PHYSICAL(move)(gBattleMoves[move].damageCategory == MOVE_CATEGORY_PHYSICAL)
#define IS_MOVE_SPECIAL(move)(gBattleMoves[move].damageCategory == MOVE_CATEGORY_SPECIAL)
#define IS_MOVE_STATUS(move)(gBattleMoves[move].damageCategory == MOVE_CATEGORY_STATUS)
