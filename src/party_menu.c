...
{
    switch (tutor)
    { // These used to be exclusive to the Gen1 starters. Now the Gen2 and Gen3 mons can get them too!
    case TUTOR_MOVE_FRENZY_PLANT:
        return (species == SPECIES_VENUSAUR || species == SPECIES_MEGANIUM || species == SPECIES_SCEPTILE);  
    case TUTOR_MOVE_BLAST_BURN:
        return (species == SPECIES_CHARIZARD || species == SPECIES_TYPHLOSION || species == SPECIES_BLAZIKEN);
    case TUTOR_MOVE_HYDRO_CANNON:
        return (species == SPECIES_BLASTOISE || species == SPECIES_FERALIGATR || species == SPECIES_SWAMPERT);
    default:
